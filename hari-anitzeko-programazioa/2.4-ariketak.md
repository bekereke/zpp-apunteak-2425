...
2. Lehenengo 1.000.000 zenbakien batura kalkulatuko duen programa bat sortu. Horretarako, batuketa 4 haritan banatuko duzu. Hari bakoitzak bere martxa amaitzen duenean, klase nagusiak kopuru osoa erakutsiko du pantailan. <mark style="background-color:blue;">Monitoreekin egin.</mark>&#x20;
3. Lehenengo 1.000.000 zenbakien batura kalkulatuko duen programa bat sortu. Horretarako, batuketa 4 haritan banatuko duzu. Hari bakoitzak bere martxa amaitzen duenean, klase nagusiak kopuru osoa erakutsiko du pantailan. <mark style="background-color:blue;">Semaforoekin egin.</mark>
4. Programa bat sortu, **ekoizle-kontsumitzailea** ereduarekin eta monitoreak darabiltzana, 2 ekoizle eta 3 kontsumitzaileduna.
5. Sortu **ekoizle-kontsumitzaile** programa semaforoekin sinkronizatuko dena.&#x20;
...
8. Idatz ezazu `Relay` izeneko klase bat, errelebo lasterketa bat honela itxuratzen duena:\
   \
