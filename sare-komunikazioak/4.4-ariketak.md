...
6.  Diseina ezazu hautaketa anitzeko azterketa-sistema bat TCP socketak erabiliz, non <mark style="background-color:blue;">hainbat bezero zerbitzarira konekta</mark> daitezkeen galderei erantzuteko. Zerbitzariak multiroskatua izan behar du, bezero askok galderak aldi berean erantzutea ahalbidetuz, bata besteari blokeatu gabe.\
    ...
    ```
    {% endcode %}
7. Sortu TCP zerbitzari bat konektatzen zaizkion bezeroen baitako zenbakia asmatuko duena. Zenbakiak 1etik 100erakoak izango dira, eta 6 aukera izango dituzte asmatzeko. Jokoa amaitu ondoren, bezeroari berriro jokatzeko aukera emango zaio. <mark style="background-color:blue;">Hainbat bezero aldi berean</mark> konekta daitezke.
