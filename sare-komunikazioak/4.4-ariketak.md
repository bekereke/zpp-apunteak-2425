...
3. Sortu <mark style="background-color:blue;">TCP zerbitzari konkurrente</mark> bat konektatzen zaizkion bezeroen baitako ausazko zenbakia asmatuko duena. Zenbakiak 1etik 100erakoak izango dira, eta 6 aukera izango dituzte asmatzeko. Zerbitzariak, bezeroak bidalitako zenbaki hori jaso, eta "zenbaki HANDIAGOA" edo "zenbaki TXIKIAGOA" dela esango dio bezeroari, erantzunean. Jokoa amaitu ondoren, bezeroari berriro jokatzeko aukera emango zaio. <mark style="background-color:blue;">Hainbat bezero aldi berean</mark> konekta daitezke.\
   \
   Erantsitako kodeak ulertzen saiatu, probatu terminal desberdinetan eta moldatu ondorengo baldintzetara. Oinarri gisa erabili dezakezu ondoko programa, mezuak letra xehean jaso eta letra larrira pasata itzultzen dituena konkurrenteki. Eraikitzailean baliabide partekatua erabiltzen duen eredua da, gainera:
